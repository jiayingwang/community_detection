...
from community_detection import CPM
...
class TestCPM(unittest.TestCase):
  ...
  def test_process(self):
    ...
    G = Graph({'E': [(1, 2), (1, 3), (1, 4), (2, 3), (2, 4), (3, 4), (4, 6), (4, 7), (4, 8), (6, 7), (6, 8), (7, 8)]})
    communities = cpm.process(G)
    self.assertEqual(communities, [[8, 4, 6, 7], [1, 2, 3, 4]])
